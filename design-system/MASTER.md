...
Single light-mode palette. Dark mode is **opt-in** — see the **Dark Mode** section at the bottom of this file. Only add the dark column when the project brief explicitly asks for it.
